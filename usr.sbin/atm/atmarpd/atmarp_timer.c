 ...
 *
 *	@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/atmarpd/atmarp_timer.c 96760 2002-05-16 23:28:40Z arr $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/atmarpd/atmarp_timer.c 96760 2002-05-16 23:28:40Z arr $");
#endif
