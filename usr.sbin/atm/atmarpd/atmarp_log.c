 ...
 *
 *	@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/atmarpd/atmarp_log.c 118164 2003-07-29 13:40:52Z harti $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/atmarpd/atmarp_log.c 118164 2003-07-29 13:40:52Z harti $");
#endif
