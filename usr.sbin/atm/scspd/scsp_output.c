 ...
 *
 *	@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/scspd/scsp_output.c 96765 2002-05-16 23:57:37Z arr $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/scspd/scsp_output.c 96765 2002-05-16 23:57:37Z arr $");
#endif
