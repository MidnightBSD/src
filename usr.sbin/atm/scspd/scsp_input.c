 ...
 *
 *	@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/scspd/scsp_input.c 104744 2002-10-10 00:32:55Z alfred $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: release/7.0.0/usr.sbin/atm/scspd/scsp_input.c 104744 2002-10-10 00:32:55Z alfred $");
#endif
