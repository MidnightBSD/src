...
# MidnightBSD release engineers.  Each disc is given a list of desired packages.
...
#
# $MidnightBSD: src/release/scripts/package-split.py,v 1.9.2.3 2011/01/28 15:12:16 laffer1 Exp $
...
def disc1_packages():
    pkgs = ['x11/xorg']
    pkgs.extend(['x11-drivers/xorg-drivers',
