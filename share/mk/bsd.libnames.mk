# $FreeBSD: stable/11/share/mk/bsd.libnames.mk 346429 2019-04-20 04:16:51Z kevans $
...
LIBBLOCKSRUNTIME?=	${DESTDIR}${LIBDIR_BASE}/libBlocksRuntime.a
...
LIBSQLITE3?=	${DESTDIR}${LIBDIR_BASE}/libsqlite3.a
...
LIBNETPGP?=	${DESTDIR}${LIBDIR_BASE}/libnetpgp.a
...
LIBUCL?=	${DESTDIR}${LIBDIR_BASE}/libucl.a
