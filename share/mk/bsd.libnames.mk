...
LIBDNS_SD?=	${LIBDESTDIR}${LIBDIR_BASE}/libdns_sd.a
...
LIBMJ?=		${LIBDESTDIR}${LIBDIR_BASE}/libmj.a
LIBMP?=		${LIBDESTDIR}${LIBDIR_BASE}/libmp.a
LIBMPORT?=	${LIBDESTDIR}${LIBDIR_BASE}/libmport.a
LIBMSEARCH?=	${LIBDESTDIR}${LIBDIR_BASE}/libmsearch.a
LIBSQLITE3?=	${LIBDESTDIR}${LIBDIR_BASE}/libsqlite3.a
...
LIBNETPGP?=	${LIBDESTDIR}${LIBDIR_BASE}/libnetpgp.a
LIBNGATM?=	${LIBDESTDIR}${LIBDIR_BASE}/libngatm.a
LIBNSS_MDNS?=	${LIBDESTDIR}${LIBDIR_BASE}/libnss_mdns.a
