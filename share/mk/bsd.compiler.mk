...
#
# COMPILER_MIDNIGHTBSD_VERSION is the compiler's __MidnightBSD_cc_version value.
#
...
${X_}COMPILER_MIDNIGHTBSD_VERSION= 0
...
.undef _v
.endif
.if !defined(${X_}COMPILER_MIDNIGHTBSD_VERSION)
${X_}COMPILER_MIDNIGHTBSD_VERSION!=	{ echo "__MidnightBSD_cc_version" | ${${cc}:N${CCACHE_BIN}} -E - 2>/dev/null || echo __MidnightBSD_cc_version; } | sed -n '$$p'
# If we get a literal "__MidnightBSD_cc_version" back then the compiler
# is a non-MidnightBSD build that doesn't support it or some other error
# occurred.
.if ${${X_}COMPILER_MIDNIGHTBSD_VERSION} == "__MidnightBSD_cc_version"
${X_}COMPILER_MIDNIGHTBSD_VERSION=	unknown
.endif
.endif
