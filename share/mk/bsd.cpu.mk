...
MACHINE_CPU += softfp
. endif
# Normally armv6 and armv7 are hard float ABI from MidnightBSD 3.x onwards. However
...
# supported. softfp support in MidnightBSD may disappear in FreeBSD 13.0 since
