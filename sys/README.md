MidnightBSD Kernel Source:
----------------------

This directory contains the source files and build glue that make up the MidnightBSD
...
| compat | Linux compatibility layer, MidnightBSD 32-bit compatibility |
