...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: release/7.0.0/sys/dev/hfa/fore_globals.c 119418 2003-08-24 17:55:58Z obrien $");
...
#ifndef lint
__RCSID("@(#) $FreeBSD: release/7.0.0/sys/dev/hfa/fore_globals.c 119418 2003-08-24 17:55:58Z obrien $");
#endif
