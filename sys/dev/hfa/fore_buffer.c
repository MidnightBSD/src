...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: release/7.0.0/sys/dev/hfa/fore_buffer.c 126075 2004-02-21 19:08:23Z harti $");
...
#ifndef lint
__RCSID("@(#) $FreeBSD: release/7.0.0/sys/dev/hfa/fore_buffer.c 126075 2004-02-21 19:08:23Z harti $");
#endif
