 ...
 *
 *	@(#) $FreeBSD: release/7.0.0/sys/dev/hfa/fore_output.c 147256 2005-06-10 16:49:24Z brooks $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: release/7.0.0/sys/dev/hfa/fore_output.c 147256 2005-06-10 16:49:24Z brooks $");
#endif
