...
# $FreeBSD: release/7.0.0/sys/dev/drm/drm-preprocess.sh 157617 2006-04-09 20:45:45Z anholt $
...
# Replace drm_pciids.h with one with a $FreeBSD: release/7.0.0/sys/dev/drm/drm-preprocess.sh 157617 2006-04-09 20:45:45Z anholt $
