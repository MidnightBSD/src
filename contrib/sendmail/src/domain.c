...
#if NAMED_BIND
SM_RCSID("@(#)$Id: domain.c,v 1.1.1.4 2007-11-23 22:10:30 laffer1 Exp $ (with name server)")
#else /* NAMED_BIND */
SM_RCSID("@(#)$Id: domain.c,v 1.1.1.4 2007-11-23 22:10:30 laffer1 Exp $ (without name server)")
#endif /* NAMED_BIND */
