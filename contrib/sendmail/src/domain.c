...
#if NAMED_BIND
SM_RCSID("@(#)$Id: domain.c,v 1.1.1.3 2006-08-04 02:03:04 laffer1 Exp $ (with name server)")
#else /* NAMED_BIND */
SM_RCSID("@(#)$Id: domain.c,v 1.1.1.3 2006-08-04 02:03:04 laffer1 Exp $ (without name server)")
#endif /* NAMED_BIND */
